...
const AdvertiserChat = () => {
  ...
  useEffect(() => {
    if (currentAdvertiser._id) {
      socket.emit("join", currentAdvertiser._id);

      axios
        .get(
          `http://localhost:5000/advertiser/messages/${currentAdvertiser._id}`
        )
  ...
  const handleSendMessage = () => {
    if (message) {
      socket.emit("message", {
        advertiserId: currentAdvertiser._id,
        message,
        sender: "advertiser",
      });
      ...
      <div className={classes.messagesContainer}>
        ...
        <div
          className={`${classes.messagesInnerContainer} ${
            messages.length == 0 && classes.emptyContainer
          }`}
        >
          {messages.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  {message.sender == "advertiser" && (
                    ...
                    >
                      <img
                        src={currentAdvertiser.imageURL}
            ...
            <p style={{ fontSize: "2.5rem" }}>No Previous Messages to Show</p>
          )}
        </div>
      </div>
