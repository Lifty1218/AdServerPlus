...
const PublisherChat = () => {
  ...
  useEffect(() => {
    if (currentPublisher._id) {
      socket.emit("join", currentPublisher._id);

      axios
        .get(`http://localhost:5000/publisher/messages/${currentPublisher._id}`)
  ...
  const handleSendMessage = () => {
    if (message) {
      socket.emit("message", {
        publisherId: currentPublisher._id,
        message,
        sender: "publisher",
      });
