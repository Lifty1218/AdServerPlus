...
function Payments() {
  ...
  const columns = [
    ...
    { name: "advertiser", title: "Advertiser Id" },
    { name: "ad", title: "Advertisement Id" },
    { name: "product", title: "Price Plan" },
  ...
  const [tableColumnExtensions] = useState([
    ...
    { columnName: "advertiser", align: "center" },
  ...
  const [editingStateColumnExtensions] = useState([
    ...
    { columnName: "advertiser", editingEnabled: false },
    { columnName: "ad", editingEnabled: false },
  ...
  const fetchPaymentData = async () => {
    const responseData = await axios.get(
      "http://localhost:5000/payment/advertisers/all"
    );
